...
uint32_t CommandContext::ReadbackTexture(ReadbackBuffer& DstBuffer, PixelBuffer& SrcBuffer)
{
    ...
    auto dst_location = CD3DX12_TEXTURE_COPY_LOCATION(DstBuffer.GetResource(), PlacedFootprint);
    auto src_location = CD3DX12_TEXTURE_COPY_LOCATION(SrcBuffer.GetResource(), 0);
