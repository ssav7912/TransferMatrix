...
#define Renderer_RootSig \
    ...
    "DescriptorTable(SRV(t10, numDescriptors = 12), visibility = SHADER_VISIBILITY_PIXEL)," \
    "CBV(b1), " \
    ...
    "StaticSampler(s13, filter = FILTER_MIN_MAG_MIP_LINEAR, addressU = TEXTURE_ADDRESS_CLAMP,"\
